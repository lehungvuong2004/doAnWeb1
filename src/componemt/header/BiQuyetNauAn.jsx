    ...
    const recipes = [
        {
            ...
            secret: "Nấu nước dùng trong 12-24 giờ trên lửa nhỏ để lấy toàn bộ hương vị từ xương, hành gừng. Bí quyết nằm ở sự kiên nhẫn và gia vị nhuyễn chuối.",
            time: "24h",
        },
        {
            title: "Cơm Chiên Tỏi",
            secret: "Tỏi phải được chiên với dầu nóng cho đến khi vàng nâu, tỏi mẫn chín hòa quyện với dầu để tạo hương thơm đặc biệt.",
            time: "15p",
        },
        {
            title: "Gà Hấp Gừng",
            secret: "Dùng gà tươi sống, hấp với lửa vừa trong 35-40 phút kế cùng nước dùng gừng tươi để giữ thịt mềm, ngọt tự nhiên.",
            time: "40p",
        },
        {
            title: "Bánh Mì Nóng",
            secret: "Lò nướng phải đủ nóng (200°C) khi cho bánh vào. Nướng cho đến khi vỏ giòn rụm, bên trong mềm và thơm nức mũi.",
            time: "25p",
        },
    ];
            ...
            >
                <div className="container">
                    ...
                    <p className="lead text-muted">
                        Khám phá những bí quyết được truyền dạy từ các đầu bếp
                        chuyên nghiệp hàng đầu để nâng cao kỹ năng nấu ăn của
                        bạn
                    </p>
                </div>
            </section>
            ...
            >
                <div className="container" style={{ maxWidth: "600px" }}>
                    <h2 className="display-5 fw-bold mb-3 text-dark">
                        Sẵn Sàng Trở Thành Đầu Bếp Chuyên Nghiệp?
                    </h2>
                    <p className="lead text-muted mb-4">
                        Áp dụng những bí quyết này vào bếp nhà bạn và tạo ra
                        những bữa ăn tuyệt vời cho gia đình và bạn bè!
                    </p>
