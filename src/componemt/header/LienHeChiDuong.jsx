...
function LienHeChiDuong() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    setLoading(true)
    if (!formData.hoTen || !formData.email || !formData.phone || !formData.mess) {
    ...
    setTimeout(() => {
      setMessage({ type: "success", text: "✅ Cảm ơn bạn! Chúng tôi sẽ liên hệ sớm" })
        ...
        <div className="container">
         <p><Link to="/" className="fs-14 text-dark">Quay Lại Trang Chủ</Link></p>
          ...
          <div className="text-center mb-5">
            ...
            <p className="lead text-muted">Ghé thăm chúng tôi hoặc liên hệ để đặt bàn</p>
          </div>
          ...
          <div className="row g-4">
              ...
              <div className="card h-100 border-0 shadow-sm hover-shadow">
                <div className="card-body p-4">
                  ...
                  <div className="d-grid gap-2 pt-3">
                    <a href="tel:0123456789" className="btn btn-warning btn-lg fw-bold">
                      ☎️ Gọi Ngay
                    </a>
                    <a href="mailto:info@nha-hang.com" className="btn btn-outline-warning btn-lg fw-bold">
                      ✉️ Gửi Email
                    </a>
                  </div>
                </div>
            ...
            <div className="col-lg-6">
              <div className="card h-100 border-0 shadow-sm">
                <div className="card-body p-4">
                  <h3 className="card-title mb-4 fw-bold">📝 Gửi Tin Nhắn</h3>
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="mb-3">
                      <label htmlFor="hoTen" className="form-label fw-bold fs-6">
                        Họ & Tên
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="mb-3">
                      <label htmlFor="phone" className="form-label fw-bold  fs-6">
                        Số Điện Thoại
                      </label>
                      <input
                        type="tel"
                    ...
                    <div className="mb-4">
                      <label htmlFor="mess" className="form-label fw-bold  fs-6">
                        Nội Dung
                      </label>
                      <textarea
            ...
            <div className="col-12">
              <div className="card border-0 shadow-sm">
                <div className="card-body p-0">
                  <h3 className="card-title p-4 mb-0 fw-bold">🗺️ Bản Đồ Chỉ Đường</h3>
                  <iframe
                    width="100%"
                    height="400"
                    style={{ border: 0 }}
